...
-->		
		<section id="report-container" class="embed-container col-lg-12 col-md-12 col-sm-12 shadow"></section>
 ...
 <%
 	...
 	out.println("Your current IP address : " + serverIP);
 %>
 ...
 -->	
	...
	<script>
		$(function () {
			...
			$.ajax({
				type: "GET",
				url: "/covid19tracker/getembedinfo",
				dataType: "json",
